  ...
  let overlay = isFadeOut =>
    style(list{
      ...
      animation(
        ...
        keyframes(
          isFadeOut
            ? list{(0, list{opacity(1.)}), (100, list{opacity(0.)})}
            : list{(0, list{opacity(0.)}), (100, list{opacity(1.)})},
        ),
      ),
    })
    ...
    style(list{
      ...
      animation(
        ...
        keyframes(
          isFadeOut
            ? list{
                (0, list{transform(translate(#percent(-50.), #percent(-50.))), opacity(1.)}),
                (
                  100,
                  list{
            ...
            : list{
                ...
                (100, list{transform(translate(#percent(-50.), #percent(-50.))), opacity(1.)}),
              },
        ),
      ),
    })

module Styles = {
  ...
  let chartContainer = style(list{position(#relative), maxWidth(#px(220)), maxHeight(#px(220))})
    ...
    style(list{
      ...
      selector(
        ...
        list{
          ...
          unsafe("stroke-dasharray", j`calc($percent * 653.45 / 100) 653.45`),
          transforms(list{#rotate(#deg(-90.)), #translateX(#percent(-100.))}),
        },
      ),
    })
}

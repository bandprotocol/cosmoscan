module Styles = {
  ...
  let version = (theme: Theme.t, isDarkMode) =>
    style(list{
      ...
      cursor(#pointer),
      zIndex(5),
      Media.mobile(list{padding2(~v=#px(5), ~h=#px(10))}),
      Media.smallMobile(list{minWidth(#px(90))}),
    })
  ...
  let link = (theme: Theme.t) =>
    style(list{
      ...
      hover(list{backgroundColor(theme.dropdownHover)}),
    })
}

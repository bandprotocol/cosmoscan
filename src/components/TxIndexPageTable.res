module Styles = {
  ...
  let failIcon = style(list{width(#px(16)), height(#px(16))})
  let msgContainer = style(list{selector("> div + div", list{marginTop(#px(24))})})
  let jsonMode = style(list{display(#flex), alignItems(#center), cursor(#pointer), height(#px(30))})
}

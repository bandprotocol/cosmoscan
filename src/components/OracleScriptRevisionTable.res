module Styles = {
  ...
  let nameContainer = style(list{width(#px(160))})

  let icon = style(list{width(#px(80)), height(#px(80))})
...
let make = (~id) =>
  {
    ...
    %Sub({
      let numRevisions = numRevisionsSub
      %Sub({
        let revisions = revisionsSub
                  ...
                  <Row alignItems=Row.Center>
                    ...
                    <Col col=Col.Three>
                      <div className={CssHelper.flexBox()}>
                        ...
                        <HSpacing size=#px(5) />
                        <Text
                          value={numRevisions > 0 ? "Revisions" : "Revision"} weight=Text.Semibold
                        />
                      </div>
                    </Col>
                    <Col col=Col.Four>
                  ...
                  <TBody
                    ...
                    <Row>
                      ...
                      <Col col=Col.Four>
                        ...
                        | Some(tx) =>
                          <Timestamp
                            time=tx.block.timestamp weight=Text.Regular code=true size=Text.Md
                          />

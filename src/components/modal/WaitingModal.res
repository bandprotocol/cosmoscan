module Styles = {
  ...
  let modalTitle = style(list{display(#flex), justifyContent(#center)})

  let icon = style(list{width(#px(30))})

  let errorContainer = style(list{
    display(#flex),
    flexDirection(#row),
    justifyContent(#center),
    alignItems(#center),
...
let make = _ => {
  ...
  <div className=Styles.container>
    ...
    <div className=Styles.innerContainer>
      ...
      | Success => <>
          <Text
            value="User Signed Successfully" weight=Text.Bold size=Text.Xxxl color=Colors.gray8
          />
          <VSpacing size=Spacing.xxl />
      ...
      | Error => <>
          ...
          <div className=Styles.errorContainer>
            ...
            <Text
              value="An error occurred" weight=Text.Medium color=Colors.red4 spacing=Text.Em(0.03)
            />
          </div>
        </>
      }}

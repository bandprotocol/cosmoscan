module Styles = {
  ...
  let rowWithWidth = (w: int) =>
    style(list{
      ...
      Media.mobile(list{
        width(#auto),
        flexWrap(#wrap),
        selector("> div:nth-child(1)", list{width(#px(90)), marginBottom(#px(10))}),
        selector(
          "> .labelContainer",
          list{
            display(#flex),
      ...
      Media.smallMobile(list{
        selector("> div:nth-child(1)", list{width(#px(68)), marginBottom(#px(10))}),
      }),
    })
  let withWidth = (w: int) => style(list{width(#px(w))})
  ...
  let addressWrapper = style(list{width(#px(120))})

  let msgContainer = style(list{
    Media.mobile(list{
      selector("> div", list{width(#percent(100.))}),
      selector("> div + div", list{marginTop(#px(8))}),
    }),
  })
}

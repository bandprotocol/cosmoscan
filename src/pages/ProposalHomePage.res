module Styles = {
  open Css
  let idContainer = style(list{
    selector(
      "> h3",
      list{
        marginLeft(#px(10)),
        marginRight(#px(10)),
        Media.mobile(list{marginLeft(#zero), marginTop(#px(8)), marginBottom(#px(8))}),
      },
    ),
  })
    ...
    <Col key={reserveIndex |> string_of_int} mb=24 mbSm=16>
      <InfoContainer>
        ...
        <Row>
          ...
          | _ =>
            <Col col=Col.Four colSm=Col.Five>
              <LoadingCensorBar width=100 height=15 mb=8 /> <LoadingCensorBar width=50 height=15 />
            </Col>
          }}
        </Row>
      </InfoContainer>
      ...
      <Row>
            ...
            ? proposals
              ->Belt_Array.mapWithIndex((i, proposal) => {
                let turnoutRate =
                  ...
                  (bondedTokenCount |> Coin.getBandAmountFromCoin) *. 100.
                <ProposalCard
                  key={i |> string_of_int}
                  reserveIndex=i
        ...
        | _ =>
          ...
          ->Belt_Array.mapWithIndex((i, noData) =>
            <ProposalCard
              key={i |> string_of_int} reserveIndex=i proposalSub=noData turnoutRate=0.
            />
          )
          ->React.array
        }}

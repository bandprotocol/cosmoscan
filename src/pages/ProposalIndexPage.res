module Styles = {
  ...
  let statusLogo = style(list{width(#px(20))})
  let resultContainer = style(list{selector("> div + div", list{marginTop(#px(24))})})

  let voteButton = x =>
    switch x {
    | ProposalSub.Voting => style(list{visibility(#visible)})
    | Deposit
    | Passed
    | Rejected
    | Failed =>
  ...
  let chartContainer = style(list{paddingRight(#px(20)), Media.mobile(list{paddingRight(#zero)})})
}
        ...
        <Col>
          <InfoContainer>
            ...
            <Row marginBottom=24 alignItems=Row.Center>
              <Col col=Col.Four mbSm=8>
                <Heading
                  value="Submit Time" size=Heading.H4 weight=Heading.Thin color=theme.textSecondary
                />
              </Col>
              <Col col=Col.Eight>
                {switch allSub {
                  ...
                  <Row marginTop=38 alignItems=Row.Center>
                    ...
                    <Col col=Col.Five>
                      <Row justify=Row.Center marginTopSm=32>
                        <Col mb=24>
                          <Heading
                            value="Total" size=Heading.H5 color=theme.textSecondary marginBottom=4
                          />
                          <Text
                        ...
                        <Col mbSm=0 colSm=Col.Six>
                          <Heading
                            ...
                            marginBottom=4
                          />
                          <Timestamp.Grid size=Text.Lg time=votingEndTime color=theme.textPrimary />
                        </Col>
                      </Row>
                    </Col>
                  </Row>

module Styles = {
  ...
  let requestResponseBox = style(list{flexShrink(0.), flexGrow(0.), flexBasis(#percent(50.))})
  let descriptionBox = style(list{
    minHeight(#px(36)),
    margin3(~top=#px(32), ~h=#zero, ~bottom=#px(16)),
  })
  let idBox = style(list{marginBottom(#px(4))})
  let tbodyContainer = style(list{minHeight(#px(600))})

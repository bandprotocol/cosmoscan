module Styles = {
  ...
  let kvTableContainer = style(list{padding(#px(1))})
  let kvTableHeader = style(list{
    padding4(~top=#px(16), ~left=#px(24), ~right=#px(24), ~bottom=#px(12)),
    Media.mobile(list{padding2(~v=#px(14), ~h=#px(12))}),
  })

  let kvTableMobile = style(list{margin(#zero), boxShadow(#none)})
  let addressContainer = style(list{Media.mobile(list{width(#px(260))})})
  let validatorReportStatus = style(list{marginBottom(#px(13))})
  let noPaddingBottom = style(list{paddingBottom(#zero), Media.mobile(list{paddingBottom(#zero)})})
  let ibcBadge = style(list{
    display(#flex),
    ...
    let make = () => {
      ...
      <THead>
        <Row alignItems=Row.Center>
          <Col col=Col.Three>
            <Heading value="KEY" size=Heading.H5 weight=Heading.Medium color=theme.textSecondary />
          </Col>
          <Col col=Col.Nine>
            <Heading
              value="VALUE" size=Heading.H5 weight=Heading.Medium color=theme.textSecondary
            />
          </Col>
        </Row>
      </THead>
    ...
    let make = () => {
      ...
      isMobile
        ? <MobileCard
            values={
              open InfoMobileCard
              list{("Key", Loading(60)), ("Value", Loading(60))}
            }
            idx="1"
        ...
        ? decodes
          ->Belt.Array.map(({Obi.fieldName: fieldName, fieldValue}) =>
            <MobileCard
              values={
                open InfoMobileCard
                list{("Key", Text(fieldName)), ("Value", Text(fieldValue))}
              }
            ...
            ->Belt.Array.map(({Obi.fieldName: fieldName, fieldValue}) =>
              <TBody key={fieldName ++ fieldValue}>
                <Row alignItems=Row.Center minHeight=#px(30)>
                  ...
                  <Col col=Col.Nine>
                    <Text
                      value=fieldValue color=theme.textSecondary weight=Text.Thin breakAll=true
                    />
                  </Col>
                </Row>
              </TBody>
        ...
        <Col>
          <InfoContainer>
            ...
            <Row marginBottom=24 alignItems=Row.Center>
              <Col col=Col.Four mbSm=8>
                <Heading
                  value="Tx Fee" size=Heading.H4 weight=Heading.Thin color=theme.textSecondary
                />
              </Col>
              <Col col=Col.Eight>
                {switch requestSub {
            ...
            <Row marginBottom=24 alignItems=Row.Center>
              <Col col=Col.Four mbSm=8>
                <Heading
                  value="Prepare Gas" size=Heading.H4 weight=Heading.Thin color=theme.textSecondary
                />
              </Col>
              <Col col=Col.Eight>
                {switch requestSub {
            ...
            <Row marginBottom=24 alignItems=Row.Center>
              <Col col=Col.Four mbSm=8>
                <Heading
                  value="Execute Gas" size=Heading.H4 weight=Heading.Thin color=theme.textSecondary
                />
              </Col>
              <Col col=Col.Eight>
                {switch requestSub {
            ...
            <Row marginBottom=24 alignItems=Row.Center>
              <Col col=Col.Four mbSm=8>
                <Heading
                  value="Fee Limit" size=Heading.H4 weight=Heading.Thin color=theme.textSecondary
                />
              </Col>
              <Col col=Col.Eight>
                {switch requestSub {
            ...
            <Row alignItems=Row.Start>
              <Col col=Col.Four mbSm=8>
                <Heading
                  value="Request to" size=Heading.H4 weight=Heading.Thin color=theme.textSecondary
                />
              </Col>
              <Col col=Col.Eight>
                <Row wrap=true>
                ...
                ->Belt.Array.map(({externalID, dataSource: {dataSourceID, name}, calldata}) =>
                  isMobile
                    ...
                    : <TBody key=externalID>
                        <Row alignItems=Row.Center minHeight=#px(30)>
                          <Col col=Col.Three>
                            <Text value=externalID color=theme.textSecondary weight=Text.Thin />
                          </Col>
                          <Col col=Col.Four>
                            <div className={CssHelper.flexBox()}>

...
external getAddressAndPubKey: (t, array<int>, string) => Js.Promise.t<addr_pukey_response_t> =
  "getAddressAndPubKey"
@send external publicKey: (t, array<int>) => Js.Promise.t<pubkey_response_t> = "publicKey"
@send external sign: (t, array<int>, string) => Js.Promise.t<sign_response_t> = "sign"
@send external getVersion: t => Js.Promise.t<version_t> = "getVersion"
@send external appInfo: t => Js.Promise.t<app_info_t> = "appInfo"
